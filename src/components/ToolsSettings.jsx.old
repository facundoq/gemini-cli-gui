...
function ToolsSettings({ isOpen, onClose }) {
  ...
  const availableModels = [
    {
      value: "auto",
      label: "Auto model (Recommended)",
      description: "Automatically chooses the best model (Gemini 3) for the task.",
    },
    {
      value: "gemini-3.1-pro-preview",
      label: "Gemini 3.1 Pro Preview",
      description: "Latest advanced reasoning model for complex tasks.",
    },
    {
      value: "gemini-3-pro-preview",
      label: "Gemini 3 Pro Preview",
      description: "Capable next-generation model for debugging and design.",
    },
    {
      value: "gemini-3-flash-preview",
      label: "Gemini 3 Flash Preview",
      description: "High-speed next-generation model for fast iterations.",
    },
    {
      value: "gemini-2.5-pro",
      label: "Gemini 2.5 Pro",
      description: "Stable advanced model for complex tasks.",
    },
    {
      value: "gemini-2.5-flash",
      label: "Gemini 2.5 Flash",
      description: "Fast and balanced model for general tasks.",
    },
    {
      value: "gemini-2.5-flash-lite",
      label: "Gemini 2.5 Flash Lite",
      description: "Fastest possible model for simple tasks.",
    },
  ];
  ...
  const approvalModes = [
    {
      ...
      description: "Prompt for all tool approvals (Secure).",
    },
    {
      value: "auto_edit",
      label: "Auto-edit",
    ...
    {
      value: "yolo",
      label: "YOLO (Full Auto)",
      description: "Auto-approve all tools including shell commands (Fastest).",
    },
    {
      value: "plan",
      label: "Plan (Read-only)",
      description: "Research-only mode. Cannot modify files or run commands.",
    },
  ];
          ...
          <div className="border-b border-border">
            <div className="flex px-4 md:px-6">
              <button
                ...
                className={`px-4 py-3 text-sm font-medium border-b-2 transition-colors ${activeTab === "tools"
          ...
          <div className="p-4 md:p-6 space-y-6 md:space-y-8 pb-safe-area-inset-bottom">
            ...
            {activeTab === "tools" && (
              <div className="space-y-6 md:space-y-8">
                ...
                {/* Skip Permissions (Legacy Shortcut) */}
                <div className="space-y-4">
                  <div className="flex items-center gap-3">
                    <AlertTriangle className="w-5 h-5 text-orange-500" />
                    <h3 className="text-lg font-medium text-foreground">Quick Permissions</h3>
                  </div>
                    ...
                    <label className="flex items-center gap-3">
                      <input
                        ...
                        onChange={(e) => {
                          ...
                          if (e.target.checked) setApprovalMode("yolo");
                          else if (approvalMode === "yolo") setApprovalMode("default");
                        }}
                        className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded focus:ring-blue-500"
                      />
                      <div>
                        ...
                        <div className="text-sm text-orange-700 dark:text-orange-300">
                          Quickly enable/disable full auto-approval
                        </div>
                      </div>
                    </label>
                  </div>
                  ...
                  <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                    <div className="space-y-3">
                      <label className="flex items-center gap-3">
                        ...
                        />
                        <div>
                          <div className="font-medium text-blue-900 dark:text-blue-100">Enable notification sound</div>
                          <div className="text-sm text-blue-700 dark:text-blue-300">
                ...
                <div className="space-y-4">
                  ...
                  <div className="space-y-2">
                    <p className="text-sm font-medium text-gray-700 dark:text-gray-300">Quick add common tools:</p>
                ...
                {/* Help Section */}
                <div className="bg-blue-50 dark:bg-blue-900/20 border border-blue-200 dark:border-blue-800 rounded-lg p-4">
                  <h4 className="font-medium text-blue-900 dark:text-blue-100 mb-2">Tool Pattern Examples:</h4>
                  <ul className="text-sm text-blue-800 dark:text-blue-200 space-y-1">
                    <li>
                      <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git log:*)"</code> - Allow all
                      git log commands
                    </li>
                    <li>
                      <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(git diff:*)"</code> - Allow all
                      git diff commands
                    </li>
                    <li>
                      <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Write"</code> - Allow all Write tool
                      usage
                    </li>
                    <li>
                      <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Read"</code> - Allow all Read tool
                      usage
                    </li>
                    <li>
                      <code className="bg-blue-100 dark:bg-blue-800 px-1 rounded">"Bash(rm:*)"</code> - Block all rm
                      commands (dangerous)
                    </li>
                  </ul>
                </div>
