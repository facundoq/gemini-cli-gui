...
export const MessageRenderer = ({ content, isDarkMode = true }) => {
  ...
  let summaryText = "";
  if (filteredContent?.includes("Error: Experiments loaded") || filteredContent?.includes("[AgentRegistry] User policy exists")) {
    isVerboseLog = true;
    summaryText = "System Configuration Logs";
  } else if (filteredContent?.startsWith("Error: ") && filteredContent.length > 500) {
    isVerboseLog = true;
